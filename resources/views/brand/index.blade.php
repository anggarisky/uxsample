        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 mb-5">
                    <a class="btn btn-primary" href="{{ route('admin.create.brand') }}">Add New</a>
                </div>
                <div class="col-lg-12">
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr> 
                                <td>{{ $brand->id }}</td>
                                <td><img height="60" src="{{ Storage::url($brand->logo) }}" alt=""></td>
                                <td>{{ $brand->name }}</td>
                                <td>
                                    <a href="{{ route('admin.edit.brand', $brand->id) }}" class="btn btn-info">Edit</a>
